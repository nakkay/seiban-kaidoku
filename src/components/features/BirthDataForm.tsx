      ...
      <div className="space-y-2.5">
        ...
        <div className="flex gap-2.5">
          <select
            ...
            className="flex-1 bg-white/[0.03] border border-white/10 rounded-lg py-2 px-3 text-text text-sm outline-none transition-all focus:border-gold focus:bg-white/[0.05]"
          >
            {years.map((y) => (
      ...
      <div className="space-y-2.5">
        ...
        <div className="flex items-center gap-2.5">
          <select
            ...
            className="flex-1 bg-white/[0.03] border border-white/10 rounded-lg py-2 px-3 text-text text-sm outline-none transition-all focus:border-gold focus:bg-white/[0.05] disabled:opacity-50"
          >
      ...
      <div className="space-y-2.5">
        ...
        {locationMode === "prefecture" ? (
          <select
            ...
            className="w-full bg-white/[0.03] border border-white/10 rounded-lg py-2 px-3 text-text text-sm outline-none transition-all focus:border-gold focus:bg-white/[0.05]"
          >
            ...
            <div className="flex gap-2.5">
              <div className="flex-1">
                <input
                  ...
                  className="w-full bg-white/[0.03] border border-white/10 rounded-lg py-2 px-3 text-text text-sm outline-none transition-all focus:border-gold focus:bg-white/[0.05] placeholder:text-text-muted"
                />
              </div>
              <div className="flex-1">
                <input
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {styles.map(([key, style]) => (
        ...
        >
          ...
          <p className="text-xs text-text-muted bg-black/20 p-3.5 rounded-lg leading-relaxed">
            {style.example}
          </p>
        </button>
      ))}
